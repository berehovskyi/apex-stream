...
Returns lazily concatenated `DoubleEnumerable` from `iterables`.
...
Double firstGreaterThan4Double = (Double) DoubleStream.of(new List<Double>{ 0.01, 1.0, 3, 5.5, -8.99, -6, 4.01 })
